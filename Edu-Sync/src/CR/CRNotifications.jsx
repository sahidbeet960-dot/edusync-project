...
const CRNotifications = () => {
  ...
  const [notifications] = useState([
    {
      id: 1,
      title: "Professor Notice",
      message: "Dr. Smith updated the Syllabus.",
      time: "2 mins ago",
      type: "alert",
    },
    {
      ...
      message: "Your proposed schedule was published.",
      time: "1 hour ago",
      type: "system",
    },
  ]);
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex justify-between items-center bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
        <h2 className="text-2xl font-bold text-slate-800 flex items-center">
          <Bell className="w-6 h-6 mr-3 text-teal-600" /> Notifications
        </h2>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-2">
        {filteredNotifs.length === 0 ? (
          ...
          filteredNotifs.map((notif) => (
            <div
              key={notif.id}
              className="p-4 border-b border-slate-100 flex items-start hover:bg-slate-50"
            >
              <div className="bg-teal-100 text-teal-600 p-2 rounded-full mr-4">
